...
/**
 * 给你一个整数数组 nums​​​ 和一个整数 k​​​​​ 。区间 [left, right]（left <= right）的 异或结果 是对下标位于 left 和 right（包括 left 和 right ）
...
public class MakeTheXorOfAllSegmentsEqualToZero {
    ...
    class Solution {
        ...
        public void printArrasys(int[] nums) {
            for (int i : nums
            ) {
                System.out.print(i + "\t");
            }
    ...
    public void test() {
        ...
        result = solution.minChanges(nums, k);
